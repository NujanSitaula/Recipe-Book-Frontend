<template>
      ...
      <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
        ...
        <form>
          <ais-instant-search :search-client="searchClient" index-name="recipes">
            ...
            <!-- Card -->
            <div class="absolute w-full max-h-[800px] overflow-auto z-50" style="height: 500px !important;">
  ...
  <!-- End Hero -->
  <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-scroll-inside-body-modal">
    Scroll inside body
  </button>
